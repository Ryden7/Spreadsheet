...
namespace PS4test
{
    ...
    public class UnitTest1
    {
        ...
        {
            Formula f = new Formula("asdfasdfasdf", s => s.ToUpper(), s => true);
        ...
        {
            Formula f1 = new Formula("x + 5");
            Assert.AreEqual(10, f1.Evaluate(s => 5));
        ...
        public void normalize()
        {
            ...
            DependencyGraph DGcopy = new DependencyGraph(DG);
        }
        ...
        public void Test()
        {
            Formula f1 = new Formula("2+g", s => s.ToUpper(), val => true);
            f1.Evaluate(s => 4);
        }
        ...
        public void test2()
        {
            Formula f1 = new Formula("2+g", s => s.ToUpper(), val => false);
